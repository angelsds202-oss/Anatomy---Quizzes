...
window.QUESTION_BANK.push(
  // ===== BOTH/LTC: chronic wounds, IPC =====
  { pack:"Year 2", track:"BOTH", topic:"Integumentary", subtopic:"Moisture damage", q:"Moisture-associated skin damage risk increases with:", choices:["Short showers","Incontinence and prolonged moisture exposure","Wearing socks","Cold weather"], answerIndex:1, explanation:"Moisture damages skin barrier; use continence care and barrier products." },
  { pack:"Year 2", track:"BOTH", topic:"Integumentary", subtopic:"Wound assessment", q:"Which is most appropriate in wound assessment documentation?", choices:["Only opinions","Size, exudate, odour, surrounding skin, pain, and changes over time","Never record measurements","Only record once"], answerIndex:1, explanation:"Objective measures and trends support safe wound care." },

  // ===== ACUTE: sepsis, anaphylaxis, line infection =====
  { pack:"Year 2", track:"ACUTE", topic:"Immune/Lymphatic", subtopic:"Sepsis escalation", q:"A patient is shivery, tachycardic, tachypnoeic and confused. Best response?", choices:["Wait for morning","Escalate urgently and use local sepsis pathway","Offer a snack","Give a blanket only"], answerIndex:1, explanation:"Red flags require urgent escalation using sepsis protocol." },
  { pack:"Year 2", track:"ACUTE", topic:"Immune/Lymphatic", subtopic:"Anaphylaxis action", q:"Suspected anaphylaxis with wheeze and swelling—priority action?", choices:["Observe quietly","Call for emergency help and follow anaphylaxis protocol","Give oral fluids","Send to sleep"], answerIndex:1, explanation:"Anaphylaxis is life-threatening; activate emergency response and follow protocol." },
  { pack:"Year 2", track:"ACUTE", topic:"Immune/Lymphatic", subtopic:"Line infection", q:"Which suggests possible IV line infection?", choices:["Local redness, pain, swelling at site +/- fever","Improved appetite","Itchy scalp","Dry lips only"], answerIndex:0, explanation:"Line site inflammation with systemic features can indicate infection—escalate." }
);
